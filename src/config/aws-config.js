...
const aws_bots_config = '[{"name":"WebUiOrderFlowers","alias":"$LATEST","description":"Bot to order flowers.","bot-template":"bot-flowers","commands-help":["I would like to pick up flowers","I would like to order some flowers","Buy flowers"],"region":"us-east-1"}]';
const aws_cognito_identity_pool_id = 'us-east-1:c078ed9b-7a2f-4dcd-92b6-6c94af6c0b26';
